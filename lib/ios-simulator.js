...
Simulator.getLogDir = function() {
  var args = Array.prototype.slice.call(arguments);
  var device = args[0];
  var home = process.env.HOME;
  var dir = path.resolve(home, 'Library', 'Logs', 'CoreSimulator', device);
  return dir
};

Simulator.getAppDir = function() {
  var args = Array.prototype.slice.call(arguments);
  var device = args[0];
  var home = process.env.HOME;
  var dir = path.resolve(home, 'Library', 'Developer', 'CoreSimulator', 'Devices', device, 'data', 'Containers', 'Bundle', 'Application');
  return dir;
};
